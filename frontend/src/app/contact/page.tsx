                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-700 dark:text-gray-300">contact@swastify.com</p>
                        <p className="text-zinc-700 dark:text-gray-300">support@swastify.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-700 dark:text-gray-300">+1 (555) 123-4567</p>
                        <p className="text-zinc-700 dark:text-gray-300">+1 (555) 987-6543</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-medium text-zinc-900 dark:text-white">Business Hours</h3>
                        <p className="text-zinc-700 dark:text-gray-300">
                ...
                <div className="bg-deep-green/10 dark:bg-light-green/10 p-6 rounded-lg border border-deep-green/20 dark:border-light-green/20">
                  ...
                  <div className="flex space-x-4">
                    <Button
                      variant="outline"
                      size="icon"
                      className="rounded-full border-deep-green/50 dark:border-light-green/50 text-deep-green dark:text-light-green hover:bg-deep-green/10 dark:hover:bg-light-green/10"
                    >
                      <svg
